...
namespace arc {
    ...
    enum class KeyCode {
        ...
        W, X, Y, Z, UP, DOWN, LEFT, RIGHT, SPACE, ENTER, ESCAPE, TAB, DELETE, UNKNOWN
    };
    ...
    public:
         ...
         * @param font the font to use
         * @return FRect the size of the string when printed
         */
        virtual FRect measure(const std::string& string, std::shared_ptr<IFont> font, float x, float y) = 0;
